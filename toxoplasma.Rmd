...
```{r data loading, message=FALSE, warning=FALSE, error=FALSE}
rm(list=ls(all=TRUE))
library(tidyverse)
library(rstan)
...
```{r fitting to data, message=FALSE, warning=FALSE, error=FALSE}
...
```{r main statistics for estimated parameters, , message=FALSE, warning=FALSE, error=FALSE}
...
```{r plot for figure1, message=FALSE, warning=FALSE, error=FALSE}
## df for doses
...
```{r plot for figure 2, message=FALSE, warning=FALSE, error=FALSE}
...
```{r plot for figure 3, message=FALSE, warning=FALSE, error=FALSE}
# df for vertical
# all
